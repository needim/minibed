...
gulp.task('download:releases', () => {
  return download('https://api.github.com/repos/needim/minibed/releases', {
    headers: {
      'User-Agent': 'minibed Documentation Page'
    }
  })
...
const issueLinker = {
  ...
  replace: function (match, prefix, content) {
    return '<a class="imp issue" target="_blank" href="https://github.com/needim/minibed/issues/' + match.substr(1) + '">' + match + '</a>'
  }
}
